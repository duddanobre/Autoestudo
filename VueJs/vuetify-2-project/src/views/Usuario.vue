                            ...
                            <v-card-text>
                                <v-container>
                                    ...
                                    <div v-else-if="dialogDelete === false">
                                        <v-row>
                                            <v-col cols="12" sm="6" md="12">
                                                <v-text-field type="text" v-model="user.nome" label="Nome" :rules="[v => !!v || 'Nome é requerido']" required></v-text-field>
                                            </v-col>
                                            <v-col cols="12" sm="6" md="12">
                                                <v-text-field type="text" v-model="user.email" label="Email" :rules="[v => !!v || 'Email é requerido']" required></v-text-field>
                                            </v-col>
                                            <v-col cols="12" sm="6" md="12">
                                                <v-text-field type="password" v-model="user.password" label="Senha" aria-valuemin="8"></v-text-field>
                                            </v-col>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            ...mapState('curso', ['cursos', 'curso'])
        },
        methods: {
            ...mapActions('user', ['listUser', 'setUser', 'addUser', 'editarUser', 'deletarUser']),
            ...mapActions('curso', ['listCurso', 'setCurso']),
            editItem (item) {
